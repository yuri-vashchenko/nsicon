...
namespace DayscoutIcon
{
    public partial class FrmSettings : Form
    {
        ...
        public FrmSettings()
        {
            ...
            this.tbServerUrl.Text = DayscoutIcon.Properties.Settings.Default.serverUrl;
            this.tbApiSecretSha1.Text = DayscoutIcon.Properties.Settings.Default.apiSecretSha1;
            this.numUpDownNetworkTimeout.Value = DayscoutIcon.Properties.Settings.Default.networkTimeout;
            this.numUpDownNumberDisplayRounding.Value = DayscoutIcon.Properties.Settings.Default.displayMmolDecimalsRouding;
            this.numUpDownSecondsBloodsugarValid.Value = Convert.ToDecimal(DayscoutIcon.Properties.Settings.Default.secondsGlucoseValueValid);
            ...
            this.cbBloodsugarUnits.SelectedIndex = DayscoutIcon.Properties.Settings.Default.bloodsugerUnitsIndex;
            this.chxLinkNightscout.Checked = DayscoutIcon.Properties.Settings.Default.showNightscoutTrayLink;

            this.chxAlarmLow.Checked = DayscoutIcon.Properties.Settings.Default.alarmLow;
            this.chxAlarmHigh.Checked = DayscoutIcon.Properties.Settings.Default.alarmHigh;
            this.chxAlarmLowerThenNormal.Checked = DayscoutIcon.Properties.Settings.Default.alarmLower;
            this.chxAlarmHigherThenNormal.Checked = DayscoutIcon.Properties.Settings.Default.alarmHigher;

            this.numUpDownAlarmLow.Value = DayscoutIcon.Properties.Settings.Default.alarmBlglLow;
        ...
        private void btnOk_Click(object sender, EventArgs e)
        {
            ...
            DayscoutIcon.Properties.Settings.Default.updateInterval = updateInterval;
            Program.glucoseService.setInterval(updateInterval);
            DayscoutIcon.Properties.Settings.Default.serverUrl = this.tbServerUrl.Text;
            DayscoutIcon.Properties.Settings.Default.apiSecretSha1 = this.tbApiSecretSha1.Text;
            DayscoutIcon.Properties.Settings.Default.networkTimeout = Convert.ToInt32(this.numUpDownNetworkTimeout.Value);
            DayscoutIcon.Properties.Settings.Default.displayMmolDecimalsRouding = Convert.ToInt32(this.numUpDownNumberDisplayRounding.Value);
            DayscoutIcon.Properties.Settings.Default.bloodsugerUnitsIndex = this.cbBloodsugarUnits.SelectedIndex;
            DayscoutIcon.Properties.Settings.Default.secondsGlucoseValueValid = Convert.ToInt32(this.numUpDownSecondsBloodsugarValid.Value);
            DayscoutIcon.Properties.Settings.Default.showNightscoutTrayLink = this.chxLinkNightscout.Checked;

            DayscoutIcon.Properties.Settings.Default.alarmLow = this.chxAlarmLow.Checked;
            DayscoutIcon.Properties.Settings.Default.alarmHigh = this.chxAlarmHigh.Checked;
            DayscoutIcon.Properties.Settings.Default.alarmLower = this.chxAlarmLowerThenNormal.Checked;
            DayscoutIcon.Properties.Settings.Default.alarmHigher = this.chxAlarmHigherThenNormal.Checked;

            DayscoutIcon.Properties.Settings.Default.alarmBlglLow = this.numUpDownAlarmLow.Value;
        ...
        private void chxAlarmLow_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                if (!DayscoutIcon.Properties.Settings.Default.noHypoAlarmWarningShowed)
                {
                    ...
                    DayscoutIcon.Properties.Settings.Default.noHypoAlarmWarningShowed = true;
                } else
                {
