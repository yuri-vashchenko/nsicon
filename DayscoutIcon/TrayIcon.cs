...
namespace DayscoutIcon
{
    ...
    public sealed class TrayIcon
    {
        ...
        public TrayIcon()
        {
            ...
            if (DayscoutIcon.Properties.Settings.Default.showNightscoutTrayLink)
            {
        ...
        {
            ProcessStartInfo procstartinfo = new ProcessStartInfo(DayscoutIcon.Properties.Settings.Default.serverUrl);
